...
export default function PinSetup() {
    ...
    const hashPin = async (pin: string): Promise<string> => {
        ...
        // Combine pin with salt for additional security
        ...
        return JSON.stringify({ hash, salt: saltHex });
    };
    ...
    const validateAndSavePin = async (pin: string, confirmPin: string) => {
        ...
        try {
            const hashedPinData = await hashPin(pin);
            await SecureStore.setItemAsync('walletPIN', hashedPinData);
